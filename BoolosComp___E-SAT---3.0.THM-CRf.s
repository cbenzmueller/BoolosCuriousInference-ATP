...
% 0.09/0.28  % Problem    : theBenchmark.p : TPTP v0.0.0. Released v0.0.0.
% 0.12/0.29  % Command    : run_E %s %d THM
% 0.12/0.51  % Computer : n022.cluster.edu
...
% 0.12/0.51  % DateTime   : Mon Aug  1 10:28:19 EDT 2022
% 0.12/0.51  % CPUTime    : 
% 0.25/0.66  Running higher-order on 8 cores model finding
% 0.25/0.66  Running: /export/starexec/sandbox/solver/bin/eprover-ho --delete-bad-limit=2000000000 --definitional-cnf=24 -s --print-statistics -R --print-version --proof-object --satauto-schedule=8 --cpu-limit=300 /export/starexec/sandbox/benchmark/theBenchmark.p
% 0.25/0.66  # Version: 3.0pre003-ho
% 0.25/0.69  # partial match(1): HSMSSMSSSSSNFFN
% 0.25/0.69  # Preprocessing class: HSMSSMSSSSSNHFN.
% 0.25/0.69  # Scheduled 4 strats onto 8 cores with 300 seconds (2400 total)
% 0.25/0.69  # Starting new_ho_10 with 1500s (5) cores
% 0.25/0.69  # Starting new_bool_1 with 300s (1) cores
% 0.25/0.69  # Starting full_lambda_5 with 300s (1) cores
% 0.25/0.69  # Starting new_ho_10_unif with 300s (1) cores
% 0.25/0.69  # new_ho_10 with pid 14952 completed with status 0
% 0.25/0.69  # Result found by new_ho_10
% 0.25/0.69  # partial match(1): HSMSSMSSSSSNFFN
% 0.25/0.69  # Preprocessing class: HSMSSMSSSSSNHFN.
% 0.25/0.69  # Scheduled 4 strats onto 8 cores with 300 seconds (2400 total)
% 0.25/0.69  # Starting new_ho_10 with 1500s (5) cores
% 0.25/0.69  # No SInE strategy applied
% 0.25/0.69  # Search class: HGUSS-FFMF21-MHFFFMBN
% 0.25/0.69  # partial match(3): HGUSS-FFMF31-MHFMMMBN
% 0.25/0.69  # Scheduled 6 strats onto 5 cores with 1500 seconds (1500 total)
% 0.25/0.69  # Starting new_ho_10_cnf2 with 811s (1) cores
% 0.25/0.69  # Starting new_ho_10 with 151s (1) cores
% 0.25/0.69  # Starting post_as_ho1 with 136s (1) cores
% 0.25/0.69  # Starting new_ho_9 with 136s (1) cores
% 0.25/0.69  # Starting sh5l with 136s (1) cores
% 0.25/0.69  # new_ho_9 with pid 14962 completed with status 0
% 0.25/0.69  # Result found by new_ho_9
% 0.25/0.69  # partial match(1): HSMSSMSSSSSNFFN
% 0.25/0.69  # Preprocessing class: HSMSSMSSSSSNHFN.
% 0.25/0.69  # Scheduled 4 strats onto 8 cores with 300 seconds (2400 total)
% 0.25/0.69  # Starting new_ho_10 with 1500s (5) cores
...
% 0.25/0.69  # Starting post_as_ho1 with 136s (1) cores
% 0.25/0.69  # Starting new_ho_9 with 136s (1) cores
% 0.25/0.69  # Preprocessing time       : 0.001 s
% 0.25/0.69  # Presaturation interreduction done
% 0.25/0.69  
% 0.25/0.69  # Proof found!
% 0.25/0.69  # SZS status Theorem
% 0.25/0.69  # SZS output start CNFRefutation
% See solution above
% 0.25/0.70  # Parsed axioms                        : 11
% 0.25/0.70  # Removed by relevancy pruning/SinE    : 0
% 0.25/0.70  # Initial clauses                      : 68
% 0.25/0.70  # Removed in clause preprocessing      : 5
% 0.25/0.70  # Initial clauses in saturation        : 63
% 0.25/0.70  # Processed clauses                    : 363
% 0.25/0.70  # ...of these trivial                  : 38
% 0.25/0.70  # ...subsumed                          : 128
% 0.25/0.70  # ...remaining for further processing  : 197
% 0.25/0.70  # Other redundant clauses eliminated   : 0
% 0.25/0.70  # Clauses deleted for lack of memory   : 0
% 0.25/0.70  # Backward-subsumed                    : 16
% 0.25/0.70  # Backward-rewritten                   : 11
% 0.25/0.70  # Generated clauses                    : 970
% 0.25/0.70  # ...of the previous two non-redundant : 894
% 0.25/0.70  # ...aggressively subsumed             : 0
% 0.25/0.70  # Contextual simplify-reflections      : 26
% 0.25/0.70  # Paramodulations                      : 966
% 0.25/0.70  # Factorizations                       : 0
% 0.25/0.70  # NegExts                              : 0
% 0.25/0.70  # Equation resolutions                 : 0
% 0.25/0.70  # Propositional unsat checks           : 0
% 0.25/0.70  #    Propositional check models        : 0
% 0.25/0.70  #    Propositional check unsatisfiable : 0
% 0.25/0.70  #    Propositional clauses             : 0
% 0.25/0.70  #    Propositional clauses after purity: 0
% 0.25/0.70  #    Propositional unsat core size     : 0
% 0.25/0.70  #    Propositional preprocessing time  : 0.000
% 0.25/0.70  #    Propositional encoding time       : 0.000
% 0.25/0.70  #    Propositional solver time         : 0.000
% 0.25/0.70  #    Success case prop preproc time    : 0.000
% 0.25/0.70  #    Success case prop encoding time   : 0.000
% 0.25/0.70  #    Success case prop solver time     : 0.000
% 0.25/0.70  # Current number of processed clauses  : 148
% 0.25/0.70  #    Positive orientable unit clauses  : 27
% 0.25/0.70  #    Positive unorientable unit clauses: 1
% 0.25/0.70  #    Negative unit clauses             : 9
% 0.25/0.70  #    Non-unit-clauses                  : 111
% 0.25/0.70  # Current number of unprocessed clauses: 609
% 0.25/0.70  # ...number of literals in the above   : 1883
% 0.25/0.70  # Current number of archived formulas  : 0
% 0.25/0.70  # Current number of archived clauses   : 48
% 0.25/0.70  # Clause-clause subsumption calls (NU) : 4646
% 0.25/0.70  # Rec. Clause-clause subsumption calls : 4082
% 0.25/0.70  # Non-unit clause-clause subsumptions  : 152
% 0.25/0.70  # Unit Clause-clause subsumption calls : 376
% 0.25/0.70  # Rewrite failures with RHS unbound    : 0
% 0.25/0.70  # BW rewrite match attempts            : 24
% 0.25/0.70  # BW rewrite match successes           : 7
% 0.25/0.70  # Condensation attempts                : 363
% 0.25/0.70  # Condensation successes               : 0
% 0.25/0.70  # Termbank termtop insertions          : 26903
% 0.25/0.70  
% 0.25/0.70  # -------------------------------------------------
% 0.25/0.70  # User time                : 0.028 s
% 0.25/0.70  # System time              : 0.004 s
% 0.25/0.70  # Total time               : 0.032 s
% 0.25/0.70  # Maximum resident set size: 1988 pages
% 0.25/0.70  
% 0.25/0.70  # -------------------------------------------------
% 0.25/0.70  # User time                : 0.131 s
% 0.25/0.70  # System time              : 0.012 s
% 0.25/0.70  # Total time               : 0.143 s
% 0.25/0.70  # Maximum resident set size: 1728 pages
%------------------------------------------------------------------------------
